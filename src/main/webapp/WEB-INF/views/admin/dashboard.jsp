		...
		<div class="card">
			<div class="card-body">
				...
				<form id="form_consulta" action="filtrar-dashboard" method="post">
					...
					<div class="row mb-2">
						<div class="col-md-3">
							<form:input type="date" path="model.dataIni" id="dataIni"
								name="dataIni" class="form-control" />
						</div>
						<div class="col-md-3">
							<form:input type="date" path="model.dataFim" id="dataFim"
				...
				<div class="row mt-3 mb-3">
					<div class="col-md-5">
						<div class="alert alert-success mb-2">
							<div class="row">
								<div class="col-md-8">Total de contas a receber:</div>
								<div class="col-md-4">
									<strong> <fmt:formatNumber
											value="${total_contas_receber}" type="currency" />
									</strong>
								</div>
							</div>
						</div>
						<div class="alert alert-danger mb-2">
							<div class="row">
								<div class="col-md-8">Total de contas a pagar:</div>
								<div class="col-md-4">
									<strong> <fmt:formatNumber
											value="${total_contas_pagar}" type="currency" />
									</strong>
								</div>
							</div>
						</div>
						<div class="alert alert-light mb-2">
							<div class="row">
								<div class="col-md-8">Saldo:</div>
								<div class="col-md-4">
									<strong> <fmt:formatNumber
											value="${total_contas_receber - total_contas_pagar}"
											type="currency" />
									</strong>
								</div>
							</div>
