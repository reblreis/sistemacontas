	...
	<div class="container mt-3">
		...
		<div class="card">
			<div class="card-body">
				...
				<p>Preencha os campos para incluir uma conta.</p>
				<hr />
				...
				<form id="form_cadastro" action="cadastrar-conta" method="post">

					<div class="row mb-2">
						<div class="col-md-6">
							<label>Nome da conta:</label>
							<form:input path="model.nome" type="text" name="nome" id="nome"
								class="form-control" />
						</div>
						<div class="col-md-3">
							<label>Valor da conta:</label>
							<form:input path="model.valor" type="text" name="valor"
								id="valor" class="form-control" />
						</div>
						<div class="col-md-3">
							<label>Data da conta:</label>
							<form:input path="model.data" type="date" name="data" id="data"
								class="form-control" />
						</div>
					</div>
					...
					<div class="row mb-2">
						<div class="col-md-3">
							...
							<div>
								<form:radiobutton path="model.tipo" name="tipo" value="1"
									checked="checked" />
								Conta a receber
							</div>
							<div>
								<form:radiobutton path="model.tipo" name="tipo" value="2" />
								Conta a pagar
							</div>
						</div>
						<div class="col-md-9">
							<label>Observações da conta:</label>
							<form:textarea path="model.observacoes" name="observacoes"
								id="observacoes" class="form-control"></form:textarea>
						</div>
					</div>
